...
public class Task1_3_8_4 {
    public static void main(String[] args)
    {
        ...
        System.out.println("Должен сделать оговорку, прошу прощения, но мне не совсем понятна суть задания. " +
                "Мною выведен результат в соответствии с тем, как я понял суть задания. \n");
